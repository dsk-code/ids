...
// import TreeClassMember from "./TreeClassMember";
...
//     const [class_list, setClass_list] = useRecoilState(classState);
//     console.log(class_list);

//     useEffect(() => {
//         // window.HSStaticMethods.autoInit();

//         const fetchedClass = async () => {
//             try {
//                 const classList: Class[] = await fetchClass();
//                 setClass_list(classList);
//             } catch (error) {
...
//     // const class_member = (class_name: string | null): User[] => {
//     //     const users = useRecoilValue(getUserByClass(class_name));
//     //     return users
//     // }
...
// return (
//     <>
//         <div id="docs-sidebar" className="hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0  transition-all hidden -translate-x-full duration-300 transform fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:bg-neutral-800 dark:border-neutral-700">
//         <div className="px-6">
...
//                         class_list.map(cls => {
//                             return(
//                                 <li key={cls.class_id} className="hs-accordion" id="users-accordion-sub-1">
//                                     <button type="button" className="hs-accordion-toggle hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-100 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-300 dark:hs-accordion-active:text-white">
//                                         {cls.class_name}
...
//                                         <TreeClassMember class_name={cls.class_name}/>
//                                     </ul>
//                                 </div>
...
// // {
// //     class_member(cls.class_name).map(user => {
// //         return (
// //             <li key={user.id}>
// //                 <Link to={`/user/${user.id}`} className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-100 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:text-neutral-300">
// //                 {user.name}
// //                 </Link>
// //             </li>
// //         )
