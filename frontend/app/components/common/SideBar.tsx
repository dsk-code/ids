...
export default function SideBar() {
    ...
    const ConditionalLink = (menu: Menu) => {
        if (!menu.submenu) {
            return (
                <li key={menu.id}>
                    <Link to={`${menu.link}`}  className={`text-gray-300 text-sm flex
        ...
        <>
            ...
            >
                <div className='inline-flex'>
                    <LuPanelLeftOpen className={`bg-amber-300 text-4xl text-black
                                    ...
                                    <ul className='duration-100'>
                                        {
                                            menu.submenuItems.map((submenuItem) => (
                                                <li key={submenuItem.id}>
                                                    <Link to={`${menu.link}${submenuItem.title}`} className='text-gray-300 text-sm flex
