...
import { Class, RequestPutClass } from '~/types/classes/classTypes';
import { notifications } from '@mantine/notifications';
import { useGetRequest } from '~/hooks/request/useGetRequest';
import { DeleteRequestParts, GetRequestParts, PutRequestParts } from '~/types/request/requestPartsTypes';
